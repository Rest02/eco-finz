...
*/
-- CreateEnum
CREATE TYPE "TransactionType" AS ENUM ('INGRESO', 'EGRESO', 'AHORRO');

-- CreateEnum
CREATE TYPE "AccountType" AS ENUM ('BANCO', 'EFECTIVO', 'TARJETA_CREDITO', 'BILLETERA_DIGITAL');
...
-- AddForeignKey
ALTER TABLE "Transaction" ADD CONSTRAINT "Transaction_monthlySummaryId_fkey" FOREIGN KEY ("monthlySummaryId") REFERENCES "MonthlySummary"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Budget" ADD CONSTRAINT "Budget_monthlySummaryId_fkey" FOREIGN KEY ("monthlySummaryId") REFERENCES "MonthlySummary"("id") ON DELETE CASCADE ON UPDATE CASCADE;
