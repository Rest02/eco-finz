...
#### **[] Fase 2: Componentes Reutilizables de la Interfaz (UI)**

[] En esta fase, construiremos los bloques visuales de forma aislada dentro de `src/finance/components`.

*   **[] Tarea 2.1: Creación de la carpeta de componentes.**
    *   [] Crear la carpeta `src/finance/components`.

*   **[] Tarea 2.2: Componente `AccountList`.**
    *   [] Crear el archivo `src/finance/components/AccountList.tsx`.
    *   [] Será un componente que recibe un array de `FinancialAccount` y las muestra.

*   **[] Tarea 2.3: Componente `AccountForm`.**
    *   [] Crear el archivo `src/finance/components/AccountForm.tsx`.
    *   [] Contendrá el formulario para crear/editar una cuenta.

*   **[] Tarea 2.4: Componente `MovementList`.**
    *   [] Crear el archivo `src/finance/components/MovementList.tsx`.
    *   [] Mostrará los movimientos de una cuenta.
