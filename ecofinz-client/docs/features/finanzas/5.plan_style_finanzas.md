...
### [x] Fase 3: Componentes del Dashboard (Columna Central)

Implementar los widgets visuales del área principal.

*   **[x] Tarea 3.1: `DashboardHeader`.**
...
*   **[x] Tarea 3.2: `StatsGrid` (Tarjetas Superiores).**
...
*   **[x] Tarea 3.3: `BalanceChart` (Gráfico de Barras).**
...
*   **[x] Tarea 3.4: `TransactionHistoryList`.**
...
### [x] Fase 4: Componentes del Panel Derecho (Widgets)

Implementar los widgets de la columna derecha.

*   **[x] Tarea 4.1: `CreditCardWidget`.**
