...
### [] Fase 2: Estructura del Layout (Finance Shell)

Crear el "esqueleto" que contendrá todas las páginas del módulo de finanzas.

*   **[] Tarea 2.1: Componente `Sidebar` (Navegación Izquierda).**
...
*   **[] Tarea 2.2: Componente `RightPanel` (Detalles Derecho).**
...
*   **[] Tarea 2.3: Layout Principal de Finanzas.**
