  ...
  return (
    <div className="space-y-4">
      {transactions.map((tx) => (
        <div
          key={tx.id}
          className="group relative bg-white/40 border border-white/60 p-4 md:p-5 rounded-2xl flex items-center justify-between transition-all duration-300 hover:bg-zinc-50 shadow-sm"
        >
          <div className="flex items-center gap-4">
            ...
            {/* Info */}
            <div>
              <h4 className="font-semibold text-black group-hover:text-emerald-600 transition-colors uppercase tracking-wider text-sm mb-0.5">
                {tx.description}
              </h4>
              <div className="flex items-center gap-3 text-xs text-zinc-500">
                ...
                {tx.category && (
                  <span className="flex items-center gap-1 px-2 py-0.5 bg-zinc-100 rounded-full border border-zinc-200 uppercase text-[9px] font-bold tracking-tighter text-zinc-600">
